...
// đọc data từ txt or json bằng fileReader API
...
$(document).ready(function(){
	...
	var tableBody = $('table');
        ...
        <tr id="tr${currentIndex}">
			...
			<td>
				...
				<button id="hide${currentIndex}" class="btn-hide"><span><i class="fas fa-check"></i></span></button>
				<button id="hide-x${currentIndex}" class="btn-hidex"><span><i class="fas fa-times"></i></span></button>
			</td>
		</tr>`)
        })
	...
	$(document).on('click','.btn-yes',function(){
		...
		$("#hide-x"+index).css("display","inline-block")

	});
	//hide-x

	$(document).on('click','.btn-hidex',function(){
		var index=$(this).attr("id");
		index=index.slice(index.length-1)
	...
	`	<tr id="tr${count}">
		...
		<td>
			...
			<button id="hide${count}" class="btn-hide"><span><i class="fas fa-check"></i></span></button>
			<button id="hide-x${count}" class="btn-hidex"><span><i class="fas fa-times"></i></span></button>
		</td>
	</tr>`);
	});
